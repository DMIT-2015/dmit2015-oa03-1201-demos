...
<div id="messages">
	<c:if test="${requestScope.quickPickArray != null}">
		<c:set var="quickPickArray" value="${quickPickArray}" scope="request" />
		<p>
			The LOTTO MAX quick pick numbers are:
			<strong>
			<c:forEach var="singleItem" items="${quickPickArray}">
				${singleItem}
			</c:forEach>
			</strong>
		</p>
