...
<html>
  ...
  <body>
  	...
  	<c:set var="circleBean" value="${circleBean}" scope="request" />
  	
 		<p>
 			The circle with a radius of ${circleBean.radius} 
 			has an area of <strong>${circleBean.area()}</strong>,
 			an circumference of <strong>${circleBean.circumference()}</strong>,
 			and an diameter of <strong>${circleBean.diameter()}</strong>.
 		</p>
