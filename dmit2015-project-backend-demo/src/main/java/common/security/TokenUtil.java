 ...
 * You can now use this utility to generate JWT tokens
 mvn exec:java -Dexec.mainClass=common.security.jwt.TokenUtil -Dexec.classpathScope=test -Dexec.args="user2015 USER"

 mvn exec:java -Dexec.mainClass=common.security.jwt.TokenUtil -Dexec.classpathScope=test -Dexec.args="admin2105 ADMIN"

 mvn exec:java -Dexec.mainClass=common.security.jwt.TokenUtil -Dexec.classpathScope=test -Dexec.args="useradmin2015 USER ADMIN"
