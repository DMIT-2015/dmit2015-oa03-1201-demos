...
import dmit2015.service.ProgrammaticIntervalEventTimerBean;
import dmit2015.service.ProgrammaticSingleEventTimersBean;
import dmit2015.service.ProgrammaticSingleEventWithInfoTimersBean;
import dmit2015.service.ProgrammaticTimersManagerBean;
 ...
 * 	/timers/cancel-all														DELETE			Cancel all active timers associated with the beans in the same module in which the caller bean is packaged
 *
...
curl -i -X DELETE http://localhost:8080/webapi/timers/cancel

 * Cancel all active timers associated with the beans in the same module in which the caller bean is packaged
curl -i -X DELETE http://localhost:8080/webapi/timers/cancel-all
